...
FusedFCSoftmax      (One kernel, intermediate data in registers)`}
          ...
          <Text mb={2}>GPU chip actually executes: <Code fontSize="xs" bg="whiteAlpha.100" px={2} py={0.5} borderRadius="4px">SASS</Code> (Shader Assembly)</Text>
          <UnorderedList mb={4} spacing={2}>
            <ListItem>Binary Machine code: Specific to the each GPU model</ListItem>
            <ListItem>Example: <Code fontSize="xs" bg="whiteAlpha.100" px={2} py={0.5} borderRadius="4px">FFMA</Code></ListItem>
          </UnorderedList>
          <Text mb={2}>Humans can write: <Code fontSize="xs" bg="whiteAlpha.100" px={2} py={0.5} borderRadius="4px">PTX</Code> (Parallel Thread Execution)</Text>
          <UnorderedList mb={4} spacing={2}>
            <ListItem>This is still low-level but doable</ListItem>
          </UnorderedList>
          <Text mb={2}>Programmers usually write: <Code fontSize="xs" bg="whiteAlpha.100" px={2} py={0.5} borderRadius="4px">CUDA C++</Code></Text>
          <UnorderedList mb={4} spacing={2}>
...
FP4:   3958 TFLOPs`}
          ...
          <Text mb={4}>
            But the tricky part is the <Code fontSize="xs" bg="whiteAlpha.100" px={2} py={0.5} borderRadius="4px">CALIBRATION</Code>
          </Text>
...
Layer 2 outputs: values between -1000 to 1000`}
          ...
          <Text mb={4}>
            ...
            Therefore we need to use a <Code fontSize="xs" bg="whiteAlpha.100" px={2} py={0.5} borderRadius="4px">SCALE FACTOR</Code> which can scale both layer outputs
          </Text>
          <Text mb={10}>
            The compiler runs a <Code fontSize="xs" bg="whiteAlpha.100" px={2} py={0.5} borderRadius="4px">CALIBRATION DATASET</Code> through the model, records min/max values at
...
With planning:    Peak = 300 MB`}
          ...
          <Text mb={2}>A matrix multiply: <Code fontSize="xs" bg="whiteAlpha.100" px={2} py={0.5} borderRadius="4px">C[M, N] = A[M, K] x B[K, N]</Code></Text>
